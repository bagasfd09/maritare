...
// Live phone preview pane on the right of the editor. Renders the REAL Flora
// template (props contract only) inside the device frame, scaled to fit. The
// inner viewport is a true 390×780 mobile canvas scaled by 0.692 into the frame.
export function EditorPhonePreview({ slug, previewData }: EditorPhonePreviewProps) {
  ...
  return (
    <div className="border-l border-[rgba(245,239,230,0.08)] bg-[#0d0a07] px-[30px] py-7 flex flex-col items-center overflow-y-auto">
      ...
      {/* Phone frame */}
      <div className="w-[290px] h-[560px] bg-black rounded-[38px] p-[10px] relative overflow-hidden shadow-[0_30px_60px_-20px_rgba(0,0,0,0.8),0_0_0_2px_rgba(245,239,230,0.06)]">
        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden bg-[#F0EAD8] relative">
          {/* True-size mobile canvas scaled to fit the 270×540 inner viewport. */}
          <div className="w-[270px] h-[540px] overflow-hidden rounded-[28px]">
            <div className="w-[390px] h-[780px] origin-top-left scale-[0.692] overflow-y-auto">
